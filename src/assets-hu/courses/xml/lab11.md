...
Írjunk XSLT programokat, amely a következő alfeladatokat hajtják végre:

<ol type="a">
  <li>
    Lefordítja a fenti XML dokumentumot magyarra. A tartalmat (pl. a színeket) nem kell lefordítani, csak az elemeket és attribútumokat. Az elemeket közvetlenül, XSL elemek használata nélkül hozzuk létre. A felhasználandó elnevezések a következők:
    <ul>
  ...
  <li>
    HTML formátumban írja ki a fenti dokumentum tartalmát. A következőkre figyeljünk:
    <ul>
      <li>Az oldal a <i>"Cars"</i> cím (<code>h1</code> elem) után táblázatban jelenítse meg az autók azonosítóját, csoportját, gyártóját, modelljét és árát.</li>
      <li>Az elemek és attribútumok létrehozásakor használjuk a beépített XSL elemeket.</li>
      <li>Minden sor olyan színű legyen, mint amilyen az adott autó.</li>
      <li>Az XML documentumot böngészőben megnyitva az így elkészített HTML oldal jelenjen meg.</li>
    </ul>
  </li>
</ol>
...
Írjunk XSLT programokat, amelyek elvégzik a következő alfeladatokat:

<ol type="a">
  <li>
    HTML formátumban írja ki a fenti XML dokumentum tartalmát. A következőkre figyeljünk:
    <ul>
      <li>Az oldal a <i>"CD Catalog"</i> cím (<code>h1</code> elem) után táblázatban jelenítse meg az egyes albumok összes adatát.</li>
      <li>Az elemek és attribútumok létrehozásakor használjuk a beépített XSL elemeket.</li>
      <li>Az első oszlop az azonosító legyen, az utolsó pedig tartalmazza a <i>"yes"</i> vagy <i>"no"</i> szöveget attól függően, hogy az album akciós-e.</li>
      <li>Az XML documentumot böngészőben megnyitva az így elkészített HTML oldal jelenjen meg.</li>
    </ul>
  </li>
  <li>Csoportosítja az albumokat évszám szerint, és minden évszámhoz felsorolja az oda tartozó albumokat azonosító szerint csökkenő sorrendben. Az évszámok növekvő sorrendben szerepeljenek. Az elvárt eredmény a következő:</li>
</ol>
...
Alakítsuk át a fenti XML dokumentumot XSLT segítségével egy olyan SVG képpé, amelyen a dokumentumban megadott síkidomok szerepelnek.
...
<ol type="a">
  <li>Írjunk XSLT nevesített template-et, amely egy téglalap területét számolja ki az oldalhosszak ismeretében.</li>
  <li>Írjunk XSLT függvényt, amely egy téglalap területét számolja ki az oldalhosszak ismeretében.</li>
  <li>Valósítsuk meg a faktoriális függvényt XSLT-ben.</li>
  <li>
    Írjunk XSLT függvényt, amely visszaadja az <i>i</i>-edik Fibonacci-számot:
    <ul>
  ...
  <li>Valósítsuk meg a hatványozást XSLT függvényként. A függvény <code>x</code> és <code>y</code> ismeretében adja vissza <code>x</code><sup><code>y</code></sup>-t. A függvény működjön helyesen negatív, 0 és pozitív kitevők esetén is.</li>
</ol>

## Megoldások

A feladatok megoldásai az [alábbi linkre kattintva](assets/courses/xml/lab11/solution.zip) érhetők el.
