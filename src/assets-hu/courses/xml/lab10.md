...
Írjuk meg az alábbi lekérdezések XPath kifejezéseit a fenti XML dokumentumhoz. Próbáljuk megírni a kifejezések rövidített és teljes alkaját is.

<ol type="a">
  <li>Kérdezzük le az összes <code>cd</code> elemet az XML bármely szintjén.</li>
  <li>Kérdezzük le az XML bármely szintjén lévő <code>cd</code> elemek <code>artist</code> gyerekeit.</li>
  <li>Kérdezzük le a <code>catalog</code> elem alatti <code>cd</code> elemek <code>artist</code> gyerekeit.</li>
  <li>Kérdezzük le a <code>catalog</code> elem alatti harmadik <code>cd</code> elemet.</li>
  <li>Kérdezzük le azon albumok címét, melyek előadója Bob Dylan.</li>
  <li>Kérdezzük le a '80-as évek albumainak átlagárát az átlagfüggvény segítségével.</li>
  <li>Kérdezzük le a '80-as évek albumainak átlagárát az összeg és darabszám függvények segítségével.</li>
  <li>Kérdezzük le az első és az utolsó album árának összegét.</li>
  <li>Kérdezzük le a 26-os azonosítójú albumra a következő stringet: <i>"&lt;Előadó&gt;: &lt;Cím&gt; (&lt;évszám&gt;, &lt;kiadó&gt;)"</i>. Tehát az elvárt eredmény: <i>"Joe Cocker: Unchain my heart (1987, EMI)"</i>.</li>
  <li>Kérdezzük le Luciano Pavarotti lemezének azonosítóját.</li>
  <li>Kérdezzük le az akciós <code>cd</code> elemeket.</li>
</ol>
...
Írjuk meg az alábbi lekérdezések XPath kifejezéseit a fenti XML dokumentumhoz:

<ol type="a">
  <li>Kérdezzük le azon tulajdonosokat, akiknek több mint egy autójuk van.</li>
  <li>Kérdezzük le az ezüst autók rendszámait.</li>
  <li>Kérdezzük le az ezüst autók átlagárát.</li>
  <li>Kérdezzük le, hogy hány <i>Doe</i> vezetéknevű tulajdonos van.</li>
</ol>

## Megoldások

A feladatok megoldásai az [alábbi linkre kattintva](assets/courses/xml/lab10/solution.zip) érhetők el.
