...
public class SAXApp {
	...
	private static final String INPUT_FILE_PATH = "src/data/szallodaDB.xml";
	
	// Ezek csak akkor kellenek, ha validalunk is
	private static final String JAXP_SCHEMA_LANGUAGE = "http://java.sun.com/xml/jaxp/properties/schemaLanguage";
	private static final String W3C_XML_SCHEMA = "http://www.w3.org/2001/XMLSchema";
	private static final String JAXP_SCHEMA_SOURCE = "http://java.sun.com/xml/jaxp/properties/schemaSource";
	private static final String XML_SCHEMA_PATH = "src/data/szallodaDB.xsd";
	...
	public static void main(String[] args) {
		...
		try {
			...
			DefaultHandler handler = new SzallodaHandler();
