...
Let's create a Java DOM application that executes the following steps one by one:

<ol type="a">
  <li>It calculates the average price of the Kia cars.</li>
  <li>It removes the cars of the PSA Group.</li>
  <li>It adds a new car to the document.</li>
  <li>It writes the resulting document to an external file.</li>
</ol>
...
<ol type="a">
  <li>It counts how many cars there are in the document.</li>
  <li>It sums up the owners' ages.</li>
  <li>It calculates the average of the owners' ages.</li>
...
<ol type="a">
  <li>It calculates the average price of those albums from the '80s whose identifier has only one digit.</li>
  <li>It removes the <i>"Hide your heart"</i> album from the document.</i>
  <li>It adds a new album to the end of the document.</li>
  <li>It prints the resulting XML document to the console.</li>
</ol>
